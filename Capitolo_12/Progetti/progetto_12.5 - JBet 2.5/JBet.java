...
public class JBet {
    ...
    public static void gioca(Campionato campionato, Scommessa scommessa) {       
        Risultato esito = esitoCasuale();
        double vincita = calcolaVincita(scommessa, esito);
        campionato.getPartiteCompletate().put(scommessa.partita(), esito); 
        System.out.println("Hai puntato " + scommessa.puntata().puntata() + " € su " 
            + scommessa.puntata().quota().risultato());
