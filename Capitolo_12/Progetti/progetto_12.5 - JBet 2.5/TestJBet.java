...
public class TestJBet {
	...
	Scommessa scommessa = new Scommessa(partita, new Puntata(partita.quote().sq1(), 1.0));
        JBet.gioca(campionato, scommessa);
        System.out.println("\nPartite giocate: " + 
            campionato.getPartiteGiocate().size());
        System.out.println("Vittorie squadra1: " + 
            campionato.getVittorieSquadra1().size());
        System.out.printf("Percentuale pareggi: %.2f %%\n", 
            campionato.percentualePareggi());
        System.out.println("Vittorie squadra2: " + 
            campionato.getVittorieSquadra2().size());
    }
